...
- ⚠️ **Зависание при сканировании I2C**: Полное сканирование шины через адаптер FT232H может приводить к зависанию программы.
  - **Временное решение**: Сейчас поиск устройств ограничен списком известных адресов PMBus (`0x5B`, `0x5C`, `0x58`, `0x5A`, `0x5D`, `0x4C`, `0x4D`).
  - *Статус*: Ошибка изучается, полное сканирование будет починено позже.
